let c1 = document.getElementById('content1');
 ...
 let c4 = document.getElementById('content4');
function clearAll() {
  c1.innerHTML = '';
  c2.innerHTML = '';
  c3.innerHTML = '';
...
function showJoke() {
  ...
  // Value is a string representing image URL
  let joke=document.createTextNode(randomJokeText);
  jokePara.appendChild(joke);
  c2.appendChild(jokePara);
}
...
function showQuote() {
  ...
  let quote=document.createTextNode(randomQuote.quote);
  let author=document.createTextNode(randomQuote.author);
  quotePara.appendChild(quote);
  authorPara.appendChild(author);
  c3.appendChild(quotePara);
  c3.appendChild(authorPara);
}


let showRiddleFlag=0;
let randomRiddle;
...
function showRiddle() {
  ...
  clearAll();
  let riddlePara = document.createElement('p');
  let riddle = document.createTextNode(randomRiddle.question);
  riddlePara.appendChild(riddle);
  c4.appendChild(riddlePara);
}

function revealAnswers() {
  if(showRiddleFlag===1){
  let answerPara=document.createElement('p')
  let answer=document.createTextNode(randomRiddle.answer);
  answerPara.appendChild(answer);
  c4.appendChild(answerPara);
  showRiddleFlag=0;
  }
}
